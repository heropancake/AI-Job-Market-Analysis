...
To replicate or run this environment, ensure you have the following components installed on your system.

### Prerequisites & IDE
* **IDE:** Visual Studio Code (VSC) equipped with official Python and Jupyter extensions.
* **Core Library:** Python 3.10+

### Installation & Dependencies
Run the following command in your terminal to install all required data science libraries at once:
